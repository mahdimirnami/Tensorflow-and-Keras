...
نکته : در پروژ] بهتر از نمای کلی رو با Functial API زدش یعنی قسمت ساخت مدل و در قسمت جزعیات آن مثل حلقه یا دستور شرطی داخل لایه ها رو با subclassing API زدش.

نکته : در keras از قالب HDF5 استفاده میشود یعنی ذخیره معماری مدل شامل ابرپارامتر های هر لایه و هم ذخیره تمامی پارامتر های مدل یعنی اوزان و بایاس ها استفاده میشه، بهینه سازی نیز ذخیره میشود.(model.save("name.h5"))
